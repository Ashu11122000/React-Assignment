...
const technologies = [
  ...
  },
  {
    name: "JavaScript (ES6+)",
    description:
      "Modern JavaScript features powering the application logic.",
    color: "warning",
  },
  {
    name: "Vite",
    description:
      "Lightning-fast development server and production bundler.",
    color: "success",
  },
  {
    name: "Tailwind CSS",
    description:
      "Utility-first CSS framework used for responsive design.",
    color: "info",
  },
  {
    name: "React Router",
    description:
      "Handles routing and navigation throughout the application.",
    color: "secondary",
  },
  {
    name: "Context API",
    description:
      "Global state management for the complete quiz lifecycle.",
    color: "purple",
  },
  {
    name: "Local Storage",
  ...
  },
  {
    name: "Lucide React",
    description:
      "Modern icon library used across the user interface.",
    color: "success",
  },
];
      ...
      <section>
        ...
        <Card className="space-y-6">
          ...
          <p className="leading-8 text-slate-300">
            This Quiz Application was designed
            as a portfolio-quality project rather
            than a simple assignment.
            Every module has been developed
            with scalability, maintainability,
            and code reusability in mind.
          </p>

          <p className="leading-8 text-slate-300">
            The application provides dynamic quiz
            generation across multiple categories,
            difficulty levels,
            live scoring,
            timer management,
          ...
          {technologies.map((technology) => (
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <Badge variant={technology.color}>
                  Core
                </Badge>
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <p className="leading-7 text-slate-400">
              Generate quizzes dynamically using
              category, difficulty, shuffle
              options, and configurable question
              counts.
            </p>
          </Card>
          ...
          >
            ...
            <p className="leading-7 text-slate-400">
              ...
              statistics,
              achievements,
              and settings are persisted using
...
└── Local Storage`}
          ...
          <p className="leading-8 text-slate-400">
            The project follows a layered
            architecture where presentation,
            state management,
            business logic,
            and persistence remain completely
...
└── styles/`}
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="space-y-5">
            ...
            <p className="leading-7 text-slate-400">
              Every feature has been developed
              with future expansion in mind,
              allowing additional quiz categories,
              themes,
              achievements,
              analytics,
              and integrations without major
          ...
          <Card className="space-y-5">
            ...
            <p className="leading-7 text-slate-400">
              ...
              while pages remain lightweight and
              focus only on rendering UI and
          ...
          <Card className="space-y-5">
            ...
            <p className="leading-7 text-slate-400">
              ...
              designed to be reusable throughout
              the application,
          ...
          <Card className="space-y-5">
            ...
            <p className="leading-7 text-slate-400">
              ...
              reusable hooks,
              efficient rendering,
              and modular architecture keep the
              application responsive even as it
              grows.
            </p>
          </Card>
        </div>
      ...
      <section>
        ...
        <Card className="space-y-6">
          ...
          <p className="leading-8 text-slate-300">
            This Quiz Application has been
            designed as a production-quality
            learning platform using modern
            React development practices.
          </p>

          <p className="leading-8 text-slate-300">
            The project demonstrates reusable
            ...
            responsive UI,
            local persistence,
            and scalable folder organization.
          </p>
